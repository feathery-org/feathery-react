...
// PPTX editing ships in its own chunk: fflate + fast-xml-parser + the SVG
// renderer must not enter ordinary form startup.
const PptxEditor = React.lazy(
  () => import(/* webpackChunkName: "PptxEditor" */ '../PptxEditor')
);
