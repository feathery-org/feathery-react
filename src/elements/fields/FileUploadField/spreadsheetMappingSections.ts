...
export const SPREADSHEET_MAPPING_SECTIONS: MappingSection[] = [
  ...
  section('ACH and Distribution Information', [
    'Standing ACH: Bank Type',
    'Standing ACH: Bank Account Title',
    'Standing ACH: ABA Number',
    'Standing ACH: Bank Account Number',
    'Standing ACH: Joint Bank Owner First Name',
    'Standing ACH: Joint Bank Owner Last Name',
    'Standing ACH: Joint Bank Owner Cell',
