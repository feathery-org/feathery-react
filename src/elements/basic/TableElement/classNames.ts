...
export const TABLE_CLASS = {
  ...
  saveButton: 'feathery-table-save-button',
  resetButton: 'feathery-table-reset-button',
  dirtyIndicator: 'feathery-table-dirty-indicator',
  ...
  dirtyCell: 'feathery-table-cell-dirty',
