...
export const TABLE_CLASS = {
  ...
  columnEditButton: 'feathery-table-column-edit-button',
  columnDeleteButton: 'feathery-table-column-delete-button',
  columnEditor: 'feathery-table-column-editor',
  ...
  gridColumnControls: 'feathery-table-grid-column-controls',
  gridAddColumn: 'feathery-table-grid-add-column',
