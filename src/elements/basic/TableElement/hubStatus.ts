 ...
 * row is validated data or a staged (unvalidated) row awaiting review.
 *
...
// Product wording: the hub API says verified/unverified, the form user sees
// validated/unvalidated.
export const STATUS_LABEL_VERIFIED = 'Validated';
export const STATUS_LABEL_UNVERIFIED = 'Unvalidated';
